...
| M1 | Graph persistence + Node SDK | 🟠 In progress | AF-M1-01 ✅, AF-M1-02 ✅, AF-M1-03 ✅ (2026-08-26): saveGraph mutation with optimistic concurrency (revision), per-node config validation, orphaned-edge cleanup, CONFLICT on stale revision. AF-M1-04 remains. |
