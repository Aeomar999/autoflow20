...
| M2 | Execution engine + traces | 🟠 In progress | AF-M2-01 ✅, AF-M2-02 ✅, AF-M2-03 ✅, AF-M2-04 ✅, AF-M2-05 ✅ (2026-08-26): First 7 node executors — SET/CONDITION/MERGE execute + HTTP_REQUEST enhancements (headers, queryParams, failOnNon2xx) + WEBHOOK_TRIGGER/SCHEDULE_TRIGGER no-op stubs; registered in `registry.ts` + `manifest.ts` (14 total). 156 tests, tsc + lint clean. |
