...
| M2 | Execution engine + traces | 🟠 In progress | AF-M2-01 ✅ (2026-08-26): Execution model upgraded (trigger, mode, graphSnapshot, aggregates, durationMs, indices); NodeExecution gains nodeName, typeVersion, input, output, skipReason, token/cost columns. Engine populates new fields. CANCELLED/TIMED_OUT statuses added. 98 tests. |
