...
| M2 | Execution engine + traces | 🟠 In progress | AF-M2-01 ✅, AF-M2-02 ✅, AF-M2-03 ✅, AF-M2-04 ✅, AF-M2-05 ✅, AF-M2-06 ✅, AF-M2-07 ✅ (2026-08-26): Executions UI — list page (trigger/status icons, duration/cost columns, status filter, auto-refresh while running) + detail page (metadata grid, cancel/retry/retry-from-node, per-node trace timeline with SKIPPED reasons, collapsible JsonViewer with search/copy/truncation, error + stack panels). 159 tests, tsc + lint clean. |
