...
| M2 | Execution engine + traces | 🟠 In progress | AF-M2-01 ✅, AF-M2-02 ✅ (2026-08-26): shared graph validator (`src/engine/validate.ts`) — cycles, unknown types, invalid configs, missing trigger, unconnected required inputs, disconnected warnings; deterministic topological order with alphabetical tie-breaking. Wired into engine (replaces inline topo-sort) and save boundary (rejects invalid graphs). 112 tests. |
