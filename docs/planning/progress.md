...
| M1 | Graph persistence + Node SDK | 🟠 In progress | AF-M1-01 ✅ (2026-08-26): Node SDK registry complete, 9 executors migrated, old layer deleted. AF-M1-02 ✅ (2026-08-26): NodeType enum dropped, Node.type/String, data migrated INITIAL→MANUAL_TRIGGER, new columns (typeVersion/disabled/notes). AF-M1-03/04 remain. |
