...
export const definition: NodeDefinition = {
  ...
  description:
    "Raise a QuickBooks invoice for a customer. Lines come from a JSON expression, so a sheet row or an order payload maps straight onto them.",
  icon: "FileText",
  logo: QBO_LOGO,
  keywords: ["quickbooks", "qbo", "invoice", "billing", "accounting"],
  configSchema,
  defaults: {},
  ...
  docsUrl: "/docs/nodes/QBO_CREATE_INVOICE",
};
