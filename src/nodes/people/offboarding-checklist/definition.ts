...
export const definition: NodeDefinition = {
  ...
  version: 1,
  category: "TRANSFORM",
  label: "Build Offboarding Checklist",
  description:
    "Build a role-aware offboarding checklist and expose the structured task list to downstream nodes.",
  icon: "ClipboardList",
  keywords: [
    "offboarding",
    "checklist",
  ...
  docsUrl: "/docs/nodes/OFFBOARDING_CHECKLIST",
};
