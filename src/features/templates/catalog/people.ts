  ...
  },
  {
    ...
    graph: {
      ...
      edges: [
        ...
        { source: "set-booking", target: "email-invite" },
        { source: "email-invite", target: "slack-invite" },
        { source: "condition", sourceHandle: "false", target: "email-reject" },
        { source: "email-reject", target: "slack-reject" },
      ],
    },
  },
  {
