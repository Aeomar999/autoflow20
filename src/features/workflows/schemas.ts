...
export const updateNodeSchemas = [
  ...
  makeNodeSchema("TELEGRAM_TRIGGER", configOf("TELEGRAM_TRIGGER")),
  makeNodeSchema("TELEGRAM_SEND_MESSAGE", configOf("TELEGRAM_SEND_MESSAGE")),
  makeNodeSchema("TELEGRAM_GET_FILE", configOf("TELEGRAM_GET_FILE")),
  makeNodeSchema("WAHA_TRIGGER", configOf("WAHA_TRIGGER")),
  makeNodeSchema("WAHA_SEND_MESSAGE", configOf("WAHA_SEND_MESSAGE")),
  makeNodeSchema("X_POST", configOf("X_POST")),
  makeNodeSchema("LINKEDIN_POST", configOf("LINKEDIN_POST")),
  makeNodeSchema("YOUTUBE_UPLOAD", configOf("YOUTUBE_UPLOAD")),
  makeNodeSchema("UPLOAD_POST_PUBLISH", configOf("UPLOAD_POST_PUBLISH")),
  makeNodeSchema("OPENAI_IMAGE", configOf("OPENAI_IMAGE")),
  makeNodeSchema("POLLINATIONS_IMAGE", configOf("POLLINATIONS_IMAGE")),
  makeNodeSchema("VEO_GENERATE", configOf("VEO_GENERATE")),
  makeNodeSchema("CREATOMATE_RENDER", configOf("CREATOMATE_RENDER")),
